    ...
    <div class="container">
        ...
        <v-sheet class="mx-auto" width="400" color="black">
            <v-form @submit.prevent="validateForm">
                ...
                <div>
                    <input type="radio" id="professional" value="professional" v-model="form.picked" />
                    <label for="professional">I am a professional astronomer</label>
                    <br/>
                    <input type="radio" id="study" value="study" v-model="form.picked" />
                    <label for="study">I study astronomy</label>
                    <br/>
                    <input type="radio" id="curious" value="curious" v-model="form.picked" />
                    <label for="curious">I am just curious</label>
                </div>
                <CustomInput v-model="form.customValue" />
                <CounterHours />
                <div>
...
export default {
    ...
    methods: {
        validateForm() {  
            ...
            if (this.form.firstName.trim().length < 3 || nameRegex.test(this.form.firstName)) {
            ...
            if (!this.form.lastName.trim() || this.form.lastName.trim().length > 15 || nameRegex.test(this.form.lastName)) {
